...
#define ESDWEB_HANDLERS( execution_funtion ,handler_html,handler_statics) \
    {{"/sd.min.html", HTTP_GET , execution_funtion , NULL}, true, {sdweb_html_asm_start,sdweb_html_asm_end,"",esdweb_handler,NULL}}



/* {{"/css/ota.min.css", HTTP_GET , handler_statics , NULL}, true, {ota_css_asm_start,ota_css_asm_end,"text/css",NULL}}, \
// {{"/js/ota.min.js", HTTP_GET , handler_statics , NULL}, true, {ota_js_asm_start,ota_js_asm_end,"text/javascript",NULL}}, \
